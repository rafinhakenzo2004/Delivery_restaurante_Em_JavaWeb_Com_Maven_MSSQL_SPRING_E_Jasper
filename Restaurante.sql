...
-- Mudando para cadastrar tipo de prato
...
INSERT INTO tb_tipo_prato (nome_tipo) VALUES
('Grelhado'),
('Massa'),
('Salada'),
('Sobremesa'),
...
('P00040', 'Smoothie de Abacaxi com Hortelã','PEQUENO', 16.00, 8);
GO

INSERT INTO Cliente (cpf, nome, telefone, logradouro, numero, cep, referenciaEntrega) VALUES
('00111222333', 'Ana Clara Souza',       '(11)91111-0001', 'Rua das Flores',          10,  '01001-000', 'Próximo à padaria Central'),
('00222333444', 'Bruno Lima',            '(11)92222-0002', 'Av. Paulista',            200, '01310-100', 'Em frente ao Parque Trianon'),
('00333444555', 'Carla Mendes',          '(11)93333-0003', 'Rua Augusta',             305, '01305-000', 'Ao lado da farmácia São Paulo'),
('00444555666', 'Diego Ferreira',        '(11)94444-0004', 'Rua da Consolação',       450, '01301-000', 'Portão azul'),
('00555666777', 'Elisa Rocha',           '(11)95555-0005', 'Av. Brasil',              100, '04062-000', 'Condomínio Portal, bloco B'),
('00666777888', 'Felipe Santos',         '(11)96666-0006', 'Rua Vergueiro',           600, '04102-000', 'Próximo ao metrô Vergueiro'),
('00777888999', 'Gabriela Costa',        '(11)97777-0007', 'Rua Tutóia',              88,  '04007-000', 'Casa com portão marrom'),
('00888999000', 'Henrique Alves',        '(11)98888-0008', 'Rua Joaquim Távora',      22,  '04015-000', 'Sobrado verde'),
('00999000111', 'Isabela Nunes',         '(11)99999-0009', 'Av. Jabaquara',           900, '04046-000', 'Em frente ao supermercado Extra'),
('01000111222', 'João Pedro Silva',      '(11)91010-0010', 'Rua Domingos de Moraes',  77,  '04010-000', 'Apartamento 42'),
('01111222333', 'Karina Oliveira',       '(11)91111-0011', 'Rua Funchal',             300, '04551-060', 'Torre A, andar 5'),
('01222333444', 'Leonardo Martins',      '(11)91212-0012', 'Av. Faria Lima',          500, '04538-133', 'Edifício Tempo, recepção'),
('01333444555', 'Mariana Pereira',       '(11)91313-0013', 'Rua Leopoldo Couto',      150, '04542-000', 'Próximo ao Shopping Iguatemi'),
('01444555666', 'Nicolas Carvalho',      '(11)91414-0014', 'Rua Gomes de Carvalho',   90,  '04547-005', 'Sobrado branco com jardim'),
('01555666777', 'Olivia Ribeiro',        '(11)91515-0015', 'Av. Santo Amaro',         400, '04506-001', 'Condomínio Alamedas, portaria'),
('01666777888', 'Paulo Nascimento',      '(11)91616-0016', 'Rua Pamplona',            60,  '01405-001', 'Apto 101, interfone 2'),
('01777888999', 'Quintina Araújo',       '(11)91717-0017', 'Rua Bela Cintra',         250, '01415-000', 'Portaria 24h'),
('01888999000', 'Rafael Teixeira',       '(11)91818-0018', 'Rua Oscar Freire',        400, '01426-001', 'Ao lado da Livraria Cultura'),
('01999000111', 'Sabrina Barbosa',       '(11)91919-0019', 'Av. Rebouças',            1000,'01310-900', 'Próximo ao Shopping Rebouças'),
('02000111222', 'Thiago Moreira',        '(11)92020-0020', 'Rua Haddock Lobo',        35,  '01414-001', 'Casa com câmera na porta'),
('02111222333', 'Úrsula Cardoso',        '(11)92121-0021', 'Rua da Graça',            80,  '01214-000', 'Fundos do prédio'),
('02222333444', 'Vinícius Gomes',        '(11)92222-0022', 'Av. Angélica',            500, '01227-001', 'Bloco C, apartamento 33'),
('02333444555', 'Wanda Freitas',         '(11)92323-0023', 'Rua Peixoto Gomide',      120, '01409-001', 'Em frente à praça'),
('02444555666', 'Xavier Lopes',          '(11)92424-0024', 'Rua Itapeva',             200, '01332-000', 'Prédio comercial, sala 5'),
('02555666777', 'Yasmin Castro',         '(11)92525-0025', 'Av. 9 de Julho',          700, '01313-001', 'Portaria principal'),
('02666777888', 'Zuleica Pinto',         '(11)92626-0026', 'Rua Estados Unidos',      55,  '01427-001', 'Jardim com portão automático'),
('02777888999', 'André Melo',            '(11)92727-0027', 'Rua França',              30,  '01430-010', 'Casa amarela'),
('02888999000', 'Beatriz Cruz',          '(11)92828-0028', 'Rua México',              65,  '20031-144', 'Próximo ao consulado'),
('02999000111', 'César Dias',            '(11)92929-0029', 'Rua Chile',               90,  '20031-170', 'Edifício Atlântico, 3º andar'),
('03000111222', 'Diana Fonseca',         '(11)93030-0030', 'Av. Rio Branco',          150, '20040-006', 'Recepção do prédio'),
('03111222333', 'Eduardo Cavalcanti',    '(11)93131-0031', 'Rua Primeiro de Março',   10,  '20010-000', 'Ao lado do banco'),
('03222333444', 'Flávia Monteiro',       '(11)93232-0032', 'Rua do Ouvidor',          40,  '20040-030', 'Loja no térreo'),
('03333444555', 'Gustavo Borges',        '(11)93333-0033', 'Av. Presidente Vargas',   800, '20071-003', 'Torre Sul, 10º andar'),
('03444555666', 'Helena Tavares',        '(11)93434-0034', 'Rua Uruguaiana',          60,  '20050-090', 'Mercadinho na esquina'),
('03555666777', 'Igor Rezende',          '(11)93535-0035', 'Rua da Carioca',          20,  '20051-100', 'Sobrado cinza'),
('03666777888', 'Juliana Azevedo',       '(11)93636-0036', 'Av. Atlântica',           1000,'22021-001', 'Frente à praia'),
('03777888999', 'Klaus Werner',          '(11)93737-0037', 'Rua Visconde de Pirajá',  200, '22410-002', 'Próximo ao metrô Ipanema'),
('03888999000', 'Laura Campos',          '(11)93838-0038', 'Rua Garcia d''Ávila',     80,  '22421-010', 'Boutique no térreo'),
('03999000111', 'Marcelo Viana',         '(11)93939-0039', 'Av. Vieira Souto',        500, '22420-002', 'Cobertura, último andar'),
('04000111222', 'Natália Drummond',      '(11)94040-0040', 'Rua Farme de Amoedo',     30,  '22420-020', 'Casa de esquina com varanda');
GO

INSERT INTO Pedido (idPedido, ClienteCpf, dataRealizacao, valorTotal) VALUES
('D00001', '00111222333', '2024-01-05',  63.00),
('D00002', '00222333444', '2024-01-06',  85.00),
('D00003', '00333444555', '2024-01-07', 110.00),
('D00004', '00444555666', '2024-01-08',  75.00),
('D00005', '00555666777', '2024-01-09',  42.00),
('D00006', '00666777888', '2024-01-10',  80.00),
...
('D00020', '02000111222', '2024-01-24',  85.00),
